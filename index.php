...
<body style="background-color: yellowgreen;" >
    <div class="container">
        <a href="pages/ajouter.php" class="btn_add"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <nav class="navbar bg-body-tertiary" style="width: 300px; left: 720px; bottom: 68px;">
  <div class="container" >
    <form action="pages/recherche.php" class="d-flex" method="$_POST" role="search">
    ...
    <table>
        ...
        //inclure la page de connexion
            ...
            if(mysqli_num_rows($req) == 0){
                //s'il nexiste pas d'employer dans la base de donner , alors on affiche ce message :
                echo "il n'ya pas encore d'employé ajouter !" ;
